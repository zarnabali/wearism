/*
 * Font families kept for future use but NOT imported anywhere.
 *
 * next/font executes every localFont() call in any imported module, with no
 * tree-shaking — importing this file from a layout would preload ~2MB of font
 * files even if none of the exports are referenced. Move a family back into
 * ./fonts.ts only when the design actually renders with it.
 */
